                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    >
                                        <Instagram className="w-6 h-6 text-yellow-400 group-hover:text-black transition-colors" />
                                    </a>
                                    <a
                                        ...
                                        aria-label="TikTok"
                                    >
                                        <TikTok className="w-6 h-6 text-yellow-400 group-hover:text-black transition-colors" />
                                    </a>
                                    <a
                                        ...
                                        aria-label="Facebook"
                                    >
                                        <Facebook className="w-6 h-6 text-yellow-400 group-hover:text-black transition-colors" />
                                    </a>
                                </div>
                            </div>
                        </div>
