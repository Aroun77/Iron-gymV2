...
function Home() {
  ...
  const jsonLd = {
    ...
    "@type": "ExerciseGym",
    "name": "Iron Gym",
    "image": "https://cxhhepesqvcrlwfenhck.supabase.co/storage/v1/object/public/gym-images/logo/LogoIG.png",
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <img
          src={heroBackground || "https://6960087cffe0774d846458b8.imgix.net/backgrounds/DevantIron.jpg?auto=format,compress&w=1920&fit=crop&q=85"}
