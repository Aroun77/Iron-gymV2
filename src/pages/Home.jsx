...
function Home() {
  ...
  const handleRedirect = () => {
    if (popup === "register") {
      window.location.href = "https://member.resamania.com/irongym/registration";
    } else if (popup === "login") {
      window.location.href = "https://api.resamania.com/oauth/login/irongym?client_id=26_2532ba2d23446346e4f83dda1570fdd224ce70c546251c4ce84bd734e0e18811&redirect_uri=https://member.resamania.com/irongym/&response_type=code&locale=fr";
    }
    setPopup(null);
  };
